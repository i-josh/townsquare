                    ...
                    Row(
                      children: [
                        ...
                        tokenValueNotifier.value != null
                            ? InkWell(
                                onTap: () {
                                  model.toggleShowCommentReplying();
                                },
                                child: _postAction(
                                    icon: Icons.reply,
                                    value: "",
                    ...
                    child: Column(
                      ...
                      children: [
                        TextFieldWidget(
                            minLines: 4,
                            maxLines: 4,
                            controller: model.replyCommentController,
                        ...
                        SizedBox(
                          width: 100,
                          child: SubmitButton(
                            isLoading: model.commentReplyingLoading,
                            label: "Reply",
                            submit: () => model.addReply(widget.comment),
